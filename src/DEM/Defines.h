...
// Force mode type
enum class FORCE_MODEL { HERTZIAN, HERTZIAN_FRICTIONLESS, HERTZIAN_ADHESION, CUSTOM };
...
struct TriTriCapLogEntry {
    unsigned long long primitiveContactID;
    unsigned long long patchContactID;
    bodyID_t idA_raw;
    bodyID_t idB_raw;
    bodyID_t triAID;
    bodyID_t triBID;
    bodyID_t ownerA;
    bodyID_t ownerB;
    notStupidBool_t isSphereA;
    notStupidBool_t isSphereB;
    ...
    double ownerBQz;
    unsigned int branch;
    notStupidBool_t touchPromoted;
    notStupidBool_t sameSidedRejected;
    notStupidBool_t finalContactSurvived;
    double shellHalfA;
    double shellHalfB;
    double shellDepthAdd;
    double extraMarginSize;
    double capFactor;
    double minEdge;
    double eA0;
    double eA1;
    ...
    double solverDepth;
    double solverArea;
    double distanceDepth;
    double preCapDepth;
    double capDepth;
    double postCapDepth;
    double sepDist;
    double touchTol;
    double solverNormalX;
    double solverNormalY;
    double solverNormalZ;
    double finalNormalX;
    double finalNormalY;
    double finalNormalZ;
...
struct DEMDataDT {
    ...
    TriTriCapLogEntry* triTriCapLogEntries = nullptr;
    unsigned int* triTriCapLogCount = nullptr;
    unsigned int triTriCapLogCapacity = 0;
};
